...
int main(int argc, char const *argv[])
{
    ...
    int c10,i,n0;
    double r1,r2,r3,r4,a1x,a1y,a1x0,a1y0;
    double t,tm,dt,t2,rr1,rr2,LL;
    double rx0,ry0,mf,fx,fy,ax0,ay0,ax,ay,xm,ym;
    double EE0,EET,EE1,EE2,EE3,EE4;
    ...
    for ( t = dt; t <= tm; t+=dt)
    {
        ...
        if (r3>r2)
        {
            ...
            ym=(y0+y10)*0.5;
            r4=sqrt(r4);
            fprintf(fil,"%18.6g  %18.6g  %18.6g  %18.6g  %18.6g  %18.6g  %18.6g  %18.6g  %18.6g\n",t,r4,x,x1,y,y1,xm,ym,fabs(1.-EET/EE0));
